...
%Upper left
Block_1 = LBP(1:Rows_3, ...
                                1:Column_3);

%Upper middle
Block_2 = LBP(1:Rows_3, ...
                                Column_3+1:2*Column_3);

%Upper right
Block_3 = LBP(1:Rows_3, ...
                                2*Column_3+1:end);

%Middle left
Block_4 = LBP(Rows_3+1:2*Rows_3, ...
                                1:Column_3);

%Center
Block_5 = LBP(Rows_3+1:2*Rows_3, ...
                                Column_3+1:2*Column_3);

%Middle right
Block_6 = LBP(Rows_3+1:2*Rows_3, ...
                                2*Column_3+1:end);

%Lower left
Block_7 = LBP(2*Rows_3+1:end, ...
                                1:Column_3);

%Lower middle
Block_8 = LBP(2*Rows_3+1:end, ...
                                Column_3+1:2*Column_3);

%Lower right
Block_9 = LBP(2*Rows_3+1:end, ...
                                2*Column_3+1:end);
...
%Total histogram
Total_histogram = [Histogram_1(:);Histogram_2(:);
                           Histogram_3(:);Histogram_4(:);
                           Histogram_5(:);Histogram_6(:);
